...
namespace GUI
{
    public partial class FormInventory : Form
    {
        ...
        private ProductsBUS _productBUS;
        private CategoriesBUS _categoryBUS;
        ...
        private void ApplyFilter()
        {
            ...
            if (dgv_inventory.Columns["Stock"] != null) dgv_inventory.Columns["Stock"].HeaderText = "Tồn thực tế";
