namespace GUI
{
    partial class FormManageProduct
    {
        ...
        private void InitializeComponent()
        {
            ...
            grp_topBar.Margin = new Padding(6, 8, 6, 8);
            grp_topBar.Name = "grp_topBar";
            grp_topBar.Padding = new Padding(6);
            grp_topBar.Size = new Size(1587, 102); // Chuẩn PanelHeaderHeight = 102
            grp_topBar.TabIndex = 0;
            grp_topBar.TabStop = false;
            // 
            // btn_productRefresh
            // 
            btn_productRefresh.Location = new Point(1228, 12); // Chuẩn ButtonTopBarRefreshLocation
            btn_productRefresh.Margin = new Padding(6, 8, 6, 8);
            btn_productRefresh.Name = "btn_productRefresh";
            btn_productRefresh.Size = new Size(347, 63); // Chuẩn ButtonTopBarRefreshWidth, ButtonTopBarHeight
            ...
            btn_category.Size = new Size(347, 63);
            btn_category.TabIndex = 3;
            btn_category.Text = "Danh mục";
            btn_category.UseVisualStyleBackColor = true;
            btn_category.Visible = false; // Tạm ẩn hoặc bạn có thể xếp đè tùy logic form
            btn_category.Click += btn_category_Click;
            // 
            // btn_productDelete
            // 
            btn_productDelete.Location = new Point(801, 12); // Chuẩn ButtonTopBarDeleteLocation
            btn_productDelete.Margin = new Padding(6, 8, 6, 8);
            btn_productDelete.Name = "btn_productDelete";
            btn_productDelete.Size = new Size(421, 63); // Chuẩn ButtonTopBarDeleteWidth, ButtonTopBarHeight
            ...
            // btn_productEdit
            // 
            btn_productEdit.Location = new Point(393, 12); // Chuẩn ButtonTopBarEditLocation
            btn_productEdit.Margin = new Padding(6, 8, 6, 8);
            btn_productEdit.Name = "btn_productEdit";
            btn_productEdit.Size = new Size(402, 63); // Chuẩn ButtonTopBarEditWidth, ButtonTopBarHeight
            ...
            // btn_productAdd
            // 
            btn_productAdd.Location = new Point(12, 12); // Chuẩn ButtonTopBarAddLocation
            btn_productAdd.Margin = new Padding(6, 8, 6, 8);
            btn_productAdd.Name = "btn_productAdd";
            btn_productAdd.Size = new Size(375, 63); // Chuẩn ButtonTopBarAddWidth, ButtonTopBarHeight
            ...
            grp_bottom.Location = new Point(0, 848);
            grp_bottom.Margin = new Padding(6, 8, 6, 8);
            grp_bottom.Name = "grp_bottom";
            grp_bottom.Padding = new Padding(6);
            grp_bottom.Size = new Size(1587, 102); // Chuẩn PanelStatusHeight = 102
            ...
            lbl_inventoryWarning.Location = new Point(1250, 42);
            lbl_inventoryWarning.Margin = new Padding(4, 0, 4, 0);
            lbl_inventoryWarning.Name = "lbl_inventoryWarning";
            lbl_inventoryWarning.Size = new Size(236, 19);
            ...
            lbl_statusSummary.Location = new Point(20, 42);
            lbl_statusSummary.Margin = new Padding(4, 0, 4, 0);
            lbl_statusSummary.Name = "lbl_statusSummary";
            lbl_statusSummary.Size = new Size(268, 19);
            ...
            grp_left.Location = new Point(0, 102);
            grp_left.Margin = new Padding(6, 8, 6, 8);
            grp_left.Name = "grp_left";
            grp_left.Padding = new Padding(6);
            grp_left.Size = new Size(640, 746); // Chuẩn PanelLeftWidth = 640
            grp_left.TabIndex = 2;
            ...
            dgv_categoryFilter.Location = new Point(6, 32);
            dgv_categoryFilter.Margin = new Padding(6, 8, 6, 8);
            ...
            dgv_categoryFilter.RowHeadersWidth = 102; // Chuẩn DataGridViewRowHeadersWidth = 102
            dgv_categoryFilter.RowTemplate.Height = 45;
            dgv_categoryFilter.SelectionMode = DataGridViewSelectionMode.FullRowSelect;
            dgv_categoryFilter.Size = new Size(628, 708);
            ...
            grp_main.Location = new Point(640, 102);
            grp_main.Margin = new Padding(6, 8, 6, 8);
            grp_main.Name = "grp_main";
            grp_main.Padding = new Padding(10);
            grp_main.Size = new Size(947, 746); // Chuẩn PanelRightWidth = 947 (1587 tổng - 640 trái)
            grp_main.TabIndex = 3;
            ...
            dgv_productList.ColumnHeadersHeight = 58; // Chuẩn DataGridViewColumnHeadersHeight = 58
            dgv_productList.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.DisableResizing;
            dgv_productList.Dock = DockStyle.Fill;
            dgv_productList.Location = new Point(10, 90);
            dgv_productList.Margin = new Padding(6, 8, 6, 8);
            dgv_productList.Name = "dgv_productList";
            dgv_productList.ReadOnly = true;
            dgv_productList.RowHeadersWidth = 102; // Chuẩn DataGridViewRowHeadersWidth = 102
            dgv_productList.SelectionMode = DataGridViewSelectionMode.FullRowSelect;
            dgv_productList.Size = new Size(927, 646);
            ...
            grp_mainTop.Location = new Point(10, 26);
            grp_mainTop.Margin = new Padding(6, 8, 6, 8);
            grp_mainTop.Name = "grp_mainTop";
            grp_mainTop.Padding = new Padding(6);
            grp_mainTop.Size = new Size(927, 64);
            ...
            cbb_statusFilter.Font = new Font("Microsoft Sans Serif", 12F, FontStyle.Regular, GraphicsUnit.Point, 0);
            ...
            cbb_statusFilter.Location = new Point(6, 16);
            cbb_statusFilter.Margin = new Padding(6, 8, 6, 8);
            cbb_statusFilter.Name = "cbb_statusFilter";
            cbb_statusFilter.Size = new Size(915, 29);
            cbb_statusFilter.TabIndex = 0;
            cbb_statusFilter.SelectedIndexChanged += cbb_statusFilter_SelectedIndexChanged;
            // 
            // FormManageProduct
            // 
            AutoScaleDimensions = new SizeF(17F, 41F); // Chuẩn StandardAutoScaleDimensions (17F, 41F)
            AutoScaleMode = AutoScaleMode.Font; // Chuẩn StandardAutoScaleMode = Font
            ClientSize = new Size(1587, 950); // Chuẩn StandardFormSize (1587, 950)
            Controls.Add(grp_main);
            Controls.Add(grp_left);
            Controls.Add(grp_bottom);
            Controls.Add(grp_topBar);
            Margin = new Padding(6, 8, 6, 8); // Chuẩn StandardMargin
